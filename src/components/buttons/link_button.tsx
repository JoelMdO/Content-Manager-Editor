...
const LinkButton: React.FC<LinkButtonProps> = ({editorRefs=null, index=0, 'data-cy': dataCy}) => {
    ///========================================================
    ...
    return ( 
        <>
            ...
            <dialog ref={dialogRef} className="modal bg-blue md:w-[30%] w-[60%] h-[20%] rounded shadow-lg fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" data-cy="dialog-link"> 
