    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
              ...
              <div key={entry.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="p-5">
                      ...
                      <ul className="list-none pl-0 text-sm">
                        {entry.references.map((ref, i) => (
                          <li key={i} className="mb-1 flex items-center">
                            ...
                            <a href={ref.url} className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">
                              {ref.title}
                            </a>
                          </li>
                        ))}
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 rounded transition">
                      View Details
                    </button>
                  </div>
                </div>
      ...
      <footer className="bg-gray-100 py-4 text-center text-gray-600 text-sm">
        <div className="container mx-auto">
          Developer Playbook - Your coding solutions library
        </div>
      </footer>
    </div>
  );
