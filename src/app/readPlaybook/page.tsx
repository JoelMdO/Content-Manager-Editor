    ...
    <div className="flex flex-col min-h-screen bg-blue">
      ...
      <header className="bg-blue-600 text-white p-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <BackPageButton data-cy="backpage-button-readplaybook" />
      ...
      <main className="container mx-auto flex-grow p-4">
        ...
        : isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 " data-cy="filtered-div">
              ...
              <div key={entry.id} className="bg-white rounded-lg shadow-md overflow-hidden shadow-black" >
                <div className="p-5" >
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <CustomButton type="view-note" id={`${entry.id}`} setEntries={setEntries} setViewDetails={setViewDetails} setUpdateNote={setUpdateNote} data-cy="button-view-edit-div"/>
                  </div>
                </div>
              </div>
            ))}
